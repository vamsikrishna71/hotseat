                                                            ...
                                                            <div class="item">
                                                                <div class="py-3">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p class="font-size-14 mb-0">- Feugo User</p>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">Get your free Feugo account now.</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form method="POST" class="form-horizontal" action="{{ route('register') }}"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="file"
                                                            ...
                                                            id="inputGroupFile0" name="logo" autofocus required>
                                                ...
                                                <div class="mt-4 text-center">
                                                    <p class="mb-0">By registering you agree to the Feugo <a
