            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data" id="update-profile">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" value="{{ Auth::user()->username }}" id="username" name="name" autofocus placeholder="Enter username">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="text-start mt-2">
                            <img src="{{ asset(Auth::user()->logo) }}" alt="" class="rounded-circle avatar-lg">
                        </div>
