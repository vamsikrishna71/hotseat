            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Address</h4>
                        <form action="{{ url('/updateLocation') }}" method="post">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        id="formrow-firstname-input address"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="formrow-inputCity state" name="state" value="{{ old('state',$location->state) }}"
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="formrow-inputCity city" value="{{ old('city',$location->city) }}" name="city"
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="formrow-inputZip zipcode" name="zipcode" value="{{ old('zipcode',$location->zipcode) }}" placeholder="Enter Your Zip Code">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="timezone" class="form-control" value="{{ old('timezone',$location->timezone) }}" id="formrow-inputZip timezone"
                                    ...
                                    <div class="repeater">
                                        <div data-repeater-list="zones">
                                            <div data-repeater-item class="row">
                                                <div class="mb-3 col-lg-3">
                                                    <label for="formrow-firstname-inpu"class="form-label">Building</label>
                                                    <input type="text" name="building_name" class="form-control" value="{{ old('building_name') }}"
                                                        id="formrow-firstname-input building_name" placeholder="Building Name" required>
                                                </div>
                                                <div class="mb-3 col-lg-3">
                                                ...
                                                <div class="mb-3 col-lg-3">
                                                    ...
                                                    <input type="text" class="form-control" id="formrow-inputZip zone_name" value="{{ old('zone_name') }}"
                                                    name="zone_name" placeholder="Enter Your Zone ID">
                                                </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <button type="submit"
                                                class="btn btn-primary btn-lg w-md mt-3 m-lg-3">Submit</button>
                                        </div>
